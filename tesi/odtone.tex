...
\section{Descrizione}
Esso è una implementazione open-source dello standard IEEE 802.21 rilasciata con licenza LGPLv3\cite{lgpl} ed è realizzato in C++ e reso multipiattaforma tramite la libreria {\em Boost}\cite{boost}: è possibile infatti eseguire ODTONE su sistemi GNU/Linux, Windows, Android ed OpenWrt.\cite{getstart}
