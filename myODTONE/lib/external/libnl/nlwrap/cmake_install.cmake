...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  FOREACH(file
      ...
      "$ENV{DESTDIR}/usr/local/lib/libnlwrap.so.0.5"
      "$ENV{DESTDIR}/usr/local/lib/libnlwrap.so"
      )
    IF(EXISTS "${file}" AND
       NOT IS_SYMLINK "${file}")
      FILE(RPATH_CHECK
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/lib/libnlwrap.so.0.5.0;/usr/local/lib/libnlwrap.so.0.5;/usr/local/lib/libnlwrap.so")
